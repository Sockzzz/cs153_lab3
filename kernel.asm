...
801067fe:	c7 04 24 e8 77 10 80 	movl   $0x801077e8,(%esp)
...
801068a2:	c7 04 24 2d 77 10 80 	movl   $0x8010772d,(%esp)
...
801068d0:	c7 04 24 45 77 10 80 	movl   $0x80107745,(%esp)
...
80106993:	e9 48 b9 ff ff       	jmp    801022e0 <kfree>
    panic("freevm: no pgdir");
80106998:	c7 04 24 61 77 10 80 	movl   $0x80107761,(%esp)
...
80106a7b:	c3                   	ret    
    panic("clearpteu");
80106a7c:	c7 04 24 72 77 10 80 	movl   $0x80107772,(%esp)
...
80106c02:	74 59                	je     80106c5d <copyuvm+0x1cd>
    if(!(*pte & PTE_P))
80106c04:	8b 30                	mov    (%eax),%esi
80106c06:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c0c:	74 5b                	je     80106c69 <copyuvm+0x1d9>
    pa = PTE_ADDR(*pte);
...
80106c40:	e9 1b ff ff ff       	jmp    80106b60 <copyuvm+0xd0>
      panic("copyuvm: page not present");
80106c45:	c7 04 24 96 77 10 80 	movl   $0x80107796,(%esp)
80106c4c:	e8 0f 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106c51:	c7 04 24 7c 77 10 80 	movl   $0x8010777c,(%esp)
80106c58:	e8 03 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist 2");
80106c5d:	c7 04 24 b0 77 10 80 	movl   $0x801077b0,(%esp)
80106c64:	e8 f7 96 ff ff       	call   80100360 <panic>
      panic("copyuvm: page not present 2");
80106c69:	c7 04 24 cc 77 10 80 	movl   $0x801077cc,(%esp)
80106c70:	e8 eb 96 ff ff       	call   80100360 <panic>
80106c75:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
...
80106d56:	c7 44 24 04 0c 78 10 	movl   $0x8010780c,0x4(%esp)
80106d5d:	80 
